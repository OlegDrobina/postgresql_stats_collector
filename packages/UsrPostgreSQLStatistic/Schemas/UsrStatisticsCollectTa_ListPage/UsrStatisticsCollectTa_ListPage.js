define("UsrStatisticsCollectTa_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			{
				...
				"values": {
					"clicked": {
						...
						"params": {
							"schemaName": "UsrStatsCollectParamsModalPage"
						}
					},
			...
			},
			{
				...
				"name": "FolderTree",
				"values": {
					"rootSchemaName": "UsrStatisticsCollectTa"
				}
			},
			{
				"operation": "merge",
